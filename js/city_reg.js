...
pc['天津市'] = new Array('和平区', '北辰区', '河北区','河西区', '西青区','滨海新区', '津南区', '东丽区', '武清区', '宝坻区', '红桥区', '大港区', '汉沽区', '静海县', '塘沽区', '宁河县', '蓟县', '南开区', '河东区');
...
pc['青海省'] = new Array('西宁市', '海西州', '海东地区', '海南州','海北州', '果洛州', '玉树州', '黄南藏族自治州');
...
pc['吉林省'] = new Array('吉林市', '长春市','榆树市', '白山市', '延边州', '白城市', '松原市', '辽源市', '通化市', '四平市');
