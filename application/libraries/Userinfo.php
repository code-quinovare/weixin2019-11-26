...
class Userinfo extends Base
{
    ...
    const REG_MOBILE = "/^13[0-9]{1}[0-9]{8}$|15[0-9]{1}[0-9]{8}$|18[0-9]{9}|14[0-9]{1}[0-9]{8}|19[0-9]{1}[0-9]{8}|17[0-9]{1}[0-9]{8}$/";
    const REG_CODE = "/^[0-9]{4}$/u";
    const REG_CALLOUS = "/^[01]$/u";
    const REG_AGE = "/^[0-9.]{1,5}$/";
    const REG_ACCOUNT = "/^13[0-9]{1}[0-9]{8}$|15[0-9]{1}[0-9]{8}$|18[0-9]{9}|14[0-9]{1}[0-9]{8}|19[0-9]{1}[0-9]{8}|17[0-9]{1}[0-9]{8}$/";
